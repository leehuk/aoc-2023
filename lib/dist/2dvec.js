...
exports.vecmove = exports.veclocate = exports.vecp = exports.vecinit = exports.vecdirs = exports.vecdataat = exports.vecdata = exports.vecclone = exports.degrotate = void 0;
;
;
;
...
function vecclone(vec) {
    return { row: vec.row, col: vec.col };
}
